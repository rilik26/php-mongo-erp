 ...
 *
 * AMAÇ:
 * - Korumalı alan giriş noktası
 * - Context zorunlu
 * - Header ile kullanıcı + dönem göstermek
 */
...
?>
  ...
  <body>
                    ...
                    <div class="d-flex align-items-end row">
                      ...
                      <div class="col-md-6 text-center text-md-end order-1 order-md-2">
                        <div class="card-body pb-0 px-0 pt-2">
                          <img
                            src="theme/assets/img/illustrations/illustration-john-light.png"
                            height="186"
                            class="scaleX-n1-rtl"
                            alt="View Profile"
                      ...
                      <ul class="p-0 m-0">
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-lightest rounded-3">
                              <div>
                                <img src="theme/assets/img/icons/misc/3d-illustration.png" alt="User" class="h-25" />
                              </div>
                            </div>
                          </div>
                        ...
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-lightest rounded-3">
                              <div>
                                <img src="theme/assets/img/icons/misc/finance-app-design.png" alt="User" class="h-25" />
                              </div>
                            </div>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-lightest rounded-3">
                              <div>
                                <img src="theme/assets/img/icons/misc/4-square.png" alt="User" class="h-25" />
                              </div>
                            </div>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-lightest rounded-3">
                              <div>
                                <img src="theme/assets/img/icons/misc/delta-web-app.png" alt="User" class="h-25" />
                              </div>
                            </div>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <li class="d-flex align-items-center">
                          <div class="avatar avatar-md flex-shrink-0 me-4">
                            <div class="avatar-initial bg-lightest rounded-3">
                              <div>
                                <img src="theme/assets/img/icons/misc/ecommerce-website.png" alt="User" class="h-25" />
                              </div>
                            </div>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <li class="nav-item">
                          <a
                            ...
                            <div class="avatar avatar-sm">
                              <img src="theme/assets/img/icons/brands/google.png" alt="User" />
                            </div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            ...
                            aria-selected="false">
                            <div class="avatar avatar-sm">
                              <img src="theme/assets/img/icons/brands/facebook-rounded.png" alt="User" />
                            </div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            ...
                            aria-selected="false">
                            <div class="avatar avatar-sm">
                              <img src="theme/assets/img/icons/brands/instagram-rounded.png" alt="User" />
                            </div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            ...
                            aria-selected="false">
                            <div class="avatar avatar-sm">
                              <img src="theme/assets/img/icons/brands/reddit-rounded.png" alt="User" />
                            </div>
                          </a>
                        </li>
                        <li class="nav-item">
                          ...
                          <div class="timeline-event">
                            ...
                            <div class="d-flex align-items-center mb-1">
                              <div class="badge bg-lighter rounded-3">
                                <img src="theme/assets//img/icons/misc/pdf.png" alt="img" width="20" class="me-2" />
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                  <ul class="list-unstyled users-list d-flex align-items-center avatar-group m-0 me-2">
                                    <li
                                      ...
                                      <img class="rounded-circle" src="theme/assets/img/avatars/5.png" alt="Avatar" />
                                    </li>
                                    <li
                                      data-bs-toggle="tooltip"
                                      data-popup="tooltip-custom"
                                      ...
                                      title="Allen Rieske"
                                      class="avatar pull-up">
                                      <img class="rounded-circle" src="theme/assets/img/avatars/12.png" alt="Avatar" />
                                    </li>
                                    <li
                                      data-bs-toggle="tooltip"
                                      data-popup="tooltip-custom"
                                      ...
                                      class="avatar pull-up">
                                      <img class="rounded-circle" src="theme/assets/img/avatars/6.png" alt="Avatar" />
                                    </li>
                                    <li class="avatar">
                                      <span
    ...
    <!-- build:js theme/assets/vendor/js/theme.js  -->
